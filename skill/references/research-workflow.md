# Research workflow and claim ledger

## Search sequence

1. Search `[building name] [city] official` and the local-language equivalent for identity, public functions, and official photos.
2. Search `[building name] plan`, `section`, `interior`, `structure`, `architecture`, plus local-language equivalents. Prefer official project pages, architect/engineering firms, heritage registers, institutions, peer-reviewed or established architectural publications.
3. Use image search only to discover candidate plans, sections, and interior photos. Open the originating page and record its caption, date, author/owner, and what it actually proves.
4. Cross-check facts. A single promotional rendering or uncited blog cannot establish invisible internal construction.

## Claim ledger

Create this table before generating:
